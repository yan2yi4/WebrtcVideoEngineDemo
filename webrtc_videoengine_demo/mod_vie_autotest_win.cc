...
mod_ViEAutoTestWindowManager::ViEAutoTestWindowManager()
	: _window1(NULL),
	_window2(NULL),
	_terminate(false),
...
int mod_ViEAutoTestWindowManager::CreateWindows(AutoTestRect window1Size,
	void* window1Title) {
...
bool mod_ViEAutoTestWindowManager::SetTopmostWindow() {
