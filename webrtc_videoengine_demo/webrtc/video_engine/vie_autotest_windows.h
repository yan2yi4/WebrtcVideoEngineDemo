...
class mod_ViEAutoTestWindowManager : public mod_ViEAutoTestWindowManagerInterface
{
public:
	mod_ViEAutoTestWindowManager();
	virtual ~mod_ViEAutoTestWindowManager();
	virtual void* GetWindow1();
	virtual int CreateOneWindow(AutoTestRect window1Size,
		void* window1Title);
	virtual int TerminateWindows();
